...
public class TreeCalculation extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currencies.add(getString(R.string.laotian_kip));
        currencies.add(getString(R.string.US_dollars));
        currencies.add(getString(R.string.australian_dollars));
